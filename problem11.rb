...
# horizontal_product = compute(grid)
#   if max < horizontal_product
...
# vertical_product = compute(arr_col)
#   if max < vertical_product
...
# --Original Code before refactor--
# btu_product = compute(arr_btu)
#   if max < btu_product
#     max = btu_product
#   end
  
puts "The highest product is #{$max}"
